...
$bdd = new PDO('mysql:host=localhost;dbname=delta;charset=utf8', 'root','');
...
<html>
<head>
  <title>Login | Delta Market</title>
  <meta charset="utf-8">
...
<body>
  <div class="ui top fixed menu"> 
    ...
    <a href="login_pgp.php" class="ui item"><i class="privacy icon"></i>Connexion PGP</a>
    <a href="inscription.php" class="ui item"><i class="write icon"></i>Inscription</a>
...
?>
    ...
    <div class="ui message">
      <h3 class="ui header">Vous êtes Nouveau ?&nbsp;&nbsp;<a href="inscription.php" class="ui button green">CREER UN COMPTE</a></h3>
    </div>
  </div>
</div>

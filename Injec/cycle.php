...
<div class="input">
	...
	<div class ="uirange  " style="width:200px"></div>
...
<button id="downloadButton"class ="ui fluid large teal submit button" style="background-color:#2185d0; width:120px">Generer</button>
